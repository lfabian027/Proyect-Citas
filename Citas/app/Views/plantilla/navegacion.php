<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <a class="navbar-brand" href="/administrador"> <img class="rounded-circle" src="<?=base_url()."/image/logo.jpeg"?>" width="30"
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?=site_url('/administrador') ?>"><i class="fas fa-user-edit"></i>&nbsp;&nbsp&nbsp<?php echo session('rol'); ?></a>
